...
router.post('/', requireRole(2), unitController.createUnit);
router.put('/:id', requireRole(2), unitController.updateUnit);
router.put('/:id/toggle-active', requireRole(2), unitController.toggleUnitActive);
